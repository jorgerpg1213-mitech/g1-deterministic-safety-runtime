...
## Versión 25 — Actualizada 2026-06-19 (4H-P2 cerrada — 4H completa)

> **Nota de versión (v25):** cambios respecto a v24 —
> (1) **4H-P2 CERRADA**: recovery policy hardening — causas terminales (FREEZE/NANINF/TIMESTAMP) bypassean cooldown/retry. Constante global `TERMINAL_MANUAL_RULE_IDS`. Validado focalmente.
> (2) **4H CERRADA**: P1 + P2 completas.
> (3) Anti-pattern #74 documentado: correr harness antes de que subscriber esté activo.
> (4) HEAD: pendiente commit 4H-P2.
