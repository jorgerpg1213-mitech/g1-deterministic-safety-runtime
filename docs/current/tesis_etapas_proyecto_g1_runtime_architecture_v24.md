...
## Versión 24 — Actualizada 2026-06-19 (DT-4G-004A + 4H-P1 cerrados)

> **Nota de versión (v24):** cambios respecto a v23 —
> (1) **DT-4G-004A CERRADA**: teardown activo dentro del contenedor; `SAFETY_PROC_PATTERN` como constante global única; preflight e hygiene ignoran `<defunct>`; ya no se requiere `docker restart` entre corridas normales.
> (2) **DT-4G-004B ABIERTA**: zombies `<defunct>` por falta de reaper/PID1 en `boring_noether`. No bloqueante.
> (3) **4H-P1 CERRADA**: recovery inteligente por causa implementado y validado mediante harnesses externos no invasivos. Cadena `topic → watchdog → SafetyEvent → recovery → [4H-P1] cause=...` verificada para fallen/STALE/FREEZE/NANINF (TIMESTAMP pendiente formal).
> (4) HEAD: `5005788`.
> (5) Anti-patterns #72, #73 documentados.
...
## Matriz de Transiciones — Estado al Cierre 4H-P1
...
*G1 Deterministic Safety Runtime — Tesis de Etapas v24*
*Actualizado: 2026-06-19*
*3C ✅ | 4A–4G ✅ | 4H 🔄 | 4I 🔲 | 4J 🔲 | 5A 🔒*
